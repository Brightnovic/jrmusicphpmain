...
<body class="">
            ...
            <div class="container">
                ...
                <div class="container py-2">
                    <div class="row">
                        ...
                        <div class="col img-color">
                            <a href="./html/music.php" class="text-light fw-bolder"> <i class="fas fa-music"></i>music</a>
                        </div>
    ...
    <div class="container bg-dark my-3 bg-show py-4">
        <div class="col text-capitalize text-lg-center text-light text-sm-start my-2 bg fw-bolder display-5">Music</div>
    </div>
    ...
    <div class="container  text-white my-3  ">
        ...
        <div class="col py-3  row mt-3 d-flex my-3 ">
            <?php $MUSIC = get_all_songs($start, $song_per_page); ?>
                ...
                <?php foreach ($MUSIC as $music) : ?>
                    <div class="newdiv border border-primary d-block d-flex flex my-3 ">
                        <div id="img" class="circlerounded col-2">
                            <?php if ($music['song_photo']) : ?>
                                <img src="./photos/<?= json_decode($music['song_photo'], true)['name']; ?>" alt="music background" class="col-6 image-fluid">
                            <?php else : ?>
                                <video src="./videos/<?= json_decode($music['song'], true)['name']; ?>" alt="unable to load music image" srcset="" class="imgme img img-fluid font-italic text-danger"></video>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="content py-3 d-flex my-3">
                            <div id="artise" class=" text-primary fw-bold my-3">
                                ...
                                <p><?= $music['artist']; ?> - <?= $music['song_name']; ?></p>

                                <!-- download link -->
                                <form method="post" action="./html/uploadedcontent.php?song=<?= $music['song_name']; ?>">
                                    <button name="download" value="<?= json_decode($music['song'], true)['name']; ?>" class=" link link-offset-3">Download</button>
                                </form>
                            </div>
                        </div>
                    </div>
