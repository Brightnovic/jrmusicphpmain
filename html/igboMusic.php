...
<body class="">
        ...
        <div class="container  mt-5 sectionOneBg py-4 border border-primary">
            <div class="row ">
                <div class="col text-primary text-center border-right border-primary">
                    <a href="DJMix.html" class="fw-bolder text-info">DJ mix</a>
                </div>
    ...
    <div class="container bg-dark my-3 bg-show py-4">
        <div class="col text-capitalize text-lg-center text-light text-sm-start my-2 bg fw-bolder display-5">
            Highlife Music</div>
    </div>
    ...
    <div class="container text-white">
        ...
        <div class="col py-3  row mt-3 d-flex my-3 ">
            <?php $IGBO = get_songs_by_genre("igbo", $start, $song_per_page); ?>

            <?php if ($IGBO) : ?>
                <?php foreach ($IGBO as $igbo) : ?>
                    <div class="newdiv border border-primary d-block d-flex flex my-3 ">
                        <div id="img" class="circlerounded col-2">
                            <img src="../photos/<?= json_decode($igbo['song_photo'], true)['name']; ?>" alt="unable to load music image" srcset="" class="imgme img img-fluid font-italic text-danger">
                        </div>

                        <div class="content py-3 d-flex my-3">
                            <div id="artise" class=" text-primary fw-bold my-3">
                                <!-- song title and artist -->
                                <p><?= $igbo['artist']; ?> - <?= $igbo['song_name']; ?></p>

                                <!-- download link -->
                                <form method="post" action="./uploadedcontent.php?song=<?= $igbo['song_name']; ?>">
                                    <button name="download" value="<?= json_decode($igbo['song'], true)['name']; ?>" class=" link link-offset-3">download MP3 </button>
                                </form>
                            </div>
                        </div>
                    </div>
    ...
    <!-- pagination -->
    <div class="pagination mx-auto text-light mb-5">
    ...
    <footer class="bg-show py-3 bg-dark mt-5">
        <div class="container">
            ...
            <div class="row  aMargin flex-wrap ">
                ...
                <div class="col  centerContent">
                    ...
                    <div class=""><a class="link fw-bold  text-decoration-underline text-capitalize text-light  " href="music.html">Trending
                            Songs</a></div>
                    <div><a class="link fw-bold text-decoration-underline text-capitalize text-light   " href="video.html">Videos</a>
                    </div>
