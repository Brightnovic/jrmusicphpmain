...
<body class="">
    ...
    <div class="container text-white">
        <?php $NEWS = get_songs_by_genre("news", $start, $song_per_page); ?>

        <?php if ($NEWS) : ?>
            <?php foreach ($NEWS as $news) : ?>
                <div class="col newsdiv py-3 my-3 row   border border-primary">
                    <div class="imgclassme">
                        <div id="img" class="circlerounded col-2">
                            <img src="../photos/<?= json_decode($news['song_photo'], true)['name']; ?>" alt="unable to load image" class="imgme img img-fluid font-italic">
                        </div>
                        <div id="artise" class="mx-3 text-primary fw-bold h3">
                            <?= $news['song_name']; ?>
                        </div>
                        <div id="title " class="text-primary fw-bold">
                    ...
                    <div id="link">
                        <!-- news link -->
                        <form method="post" action="./newscontent.php?news=<?= $news['song_name']; ?>">
                            <button name="download" value="<?= $news['content']; ?>" class=" link link-offset-3">Read news </button>
                        </form>
                    </div>
        ...
        <div class="container">
            ...
            <div class="row  aMargin flex-wrap ">
                ...
                <div class="col  centerContent">
                    ...
                    <div><a class="link fw-bold text-decoration-underline text-capitalize text-light   " href="music.html">popular
                            news</a></div>
                ...
                <div class="col">
                    ...
                    <div><a class="link fw-bold text-decoration-underline text-capitalize text-light   " href="../login.php">official
                            login</a></div>
