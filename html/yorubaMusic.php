...
<body class="">
    ...
    <div class="container bg-dark my-3 bg-show py-4">
        <div class="col text-capitalize text-lg-center text-light text-sm-start my-2 bg fw-bolder display-5">Yoruba music</div>
    </div>
    ...
    <div class="container  text-white my-3  ">
        ...
        <div class="col py-3  row mt-3 d-flex my-3 ">
            <?php $YORUBA = get_songs_by_genre("yoruba", $start, $song_per_page); ?>
